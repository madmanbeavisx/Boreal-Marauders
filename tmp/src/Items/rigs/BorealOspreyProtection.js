...
exports.borealOspreyProtectionPreset = exports.borealOspreyProtectionFromClone = void 0;
...
const borealOspreyProtectionProps = {
    Prefab: {
...
exports.borealOspreyProtectionFromClone = {
    fleaPriceRoubles: 322000,
    handbookParentId: "5b5f6f8786f77447ed563642",
    handbookPriceRoubles: 2467,
    itemTplToClone: ItemMap_1.ItemMap.VEST_OSPREY_MK4A_P,
    locales: {
        en: {
    ...
    newId: CustomItemMap_1.CustomItemMap.BOREAL_OSPREY_PROTECTION_MTP,
    overrideProperties: borealOspreyProtectionProps,
    parentId: BaseClasses_1.BaseClasses.VEST
};
exports.borealOspreyProtectionPreset = {
    _changeWeaponName: false,
    _encyclopedia: CustomItemMap_1.CustomItemMap.BOREAL_OSPREY_PROTECTION_MTP,
    _id: "66f66b60f1aba9085e465ef7",
    _items: [
        {
            _id: "66f652675cc67bbcdca17b2d",
            _tpl: CustomItemMap_1.CustomItemMap.BOREAL_OSPREY_PROTECTION_MTP
        },
        {
